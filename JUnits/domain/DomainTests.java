...
public class DomainTests {
	...
	// Instancias de Monitor
     ...
     // Instancias de Usuario
        ...
        usuarioE = new Usuario("123456789", "Juan", "Pérez", 30, "contraseña123", suscripcion1);
     ...
     // Instancias de Administrador
        ...
        adminE = new Administrador("123456789", "Juan", "Pérez", 30, "contraseña123");
        
     // Instancias de Entrenamiento
        entrenamiento1 = new Entrenamiento(TiposEntrenamientos.SPINNING, 60, "08:00", "09:00", monitor1, 10);
        entrenamiento2 = new Entrenamiento(TiposEntrenamientos.YOGA, 45, "15:00", "15:45", monitor1, 8);
        entrenamiento3 = new Entrenamiento(TiposEntrenamientos.BOXEO, 75, "18:30", "19:45", monitor2, 12);
