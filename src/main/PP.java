...
public class PP {
	...
	public static void main(String[] args) {
     ...
     // Instancias de Suscripcion
        ...
        entrenamiento4 = new Entrenamiento("Aeroyoga", TiposEntrenamientos.AEROYOGA, "Jueves", "10:00", "11:00", monitor1, 15);
        entrenamiento6 = new Entrenamiento("Hiit", TiposEntrenamientos.HIIT, "Viernes", "12:00", "13:00", monitor1, 12);
        entrenamiento7 = new Entrenamiento("Spinning Masterclass", TiposEntrenamientos.SPINNING, "Sabado", "18:00", "19:00", monitor2, 8);
        entrenamiento5 = new Entrenamiento("Pilates", TiposEntrenamientos.PILATES, "Domingo", "16:00", "17:00", monitor2, 10);
        entrenamiento8 = new Entrenamiento("Yoga Relax", TiposEntrenamientos.YOGA, "Lunes", "08:00", "09:00", monitor1, 10);
        entrenamiento9 = new Entrenamiento("Boxeo Intenso", TiposEntrenamientos.BOXEO, "Martes", "14:00", "15:00", monitor2, 15);
        entrenamiento10 = new Entrenamiento("Aeroyoga", TiposEntrenamientos.AEROYOGA, "Miercoles", "16:00", "17:00", monitor1, 14);
        entrenamiento11 = new Entrenamiento("Pilates", TiposEntrenamientos.PILATES, "Jueves", "11:00", "12:00", monitor2, 9);
        entrenamiento12 = new Entrenamiento("Hiit", TiposEntrenamientos.HIIT, "Viernes", "19:00", "20:00", monitor1, 11);
        entrenamiento13 = new Entrenamiento("Spinning Masterclass", TiposEntrenamientos.SPINNING, "Sabado", "15:00", "16:00", monitor2, 8);
        entrenamiento14 = new Entrenamiento("Yoga Relax", TiposEntrenamientos.YOGA, "Domingo", "09:00", "10:00", monitor1, 11);
        entrenamiento15 = new Entrenamiento("Boxeo Intenso", TiposEntrenamientos.BOXEO, "Lunes", "17:00", "18:00", monitor2, 13);
        entrenamiento16 = new Entrenamiento("Aeroyoga", TiposEntrenamientos.AEROYOGA, "Martes", "13:00", "14:00", monitor1, 12);
        entrenamiento17 = new Entrenamiento("Pilates", TiposEntrenamientos.PILATES, "Miercoles", "10:00", "11:00", monitor2, 8);
        entrenamiento18 = new Entrenamiento("Hiit", TiposEntrenamientos.HIIT, "Jueves", "20:00", "21:00", monitor1, 10);
        entrenamiento19 = new Entrenamiento("Spinning Masterclass", TiposEntrenamientos.SPINNING, "Viernes", "14:00", "15:00", monitor2, 9);
        entrenamiento20 = new Entrenamiento("Yoga Relax", TiposEntrenamientos.YOGA, "Lunes", "08:00", "09:00", monitor1, 12);
